...
# install packages
pacman -Syu
pacman -S grub efibootmgr networkmanager network-manager-applet ntfs-3g btrfs-progs dialog wpa_supplicant mtools \
		...
		openbsd-netcat iptables-nft ipset firewalld flatpak sof-firmware nss-mdns acpid os-prober \
